...
{printf("kudos_main_window6\n");
  if(!qnode.setActuatorState(true))
  {printf("kudos_main_window7\n");
...
{printf("kudos_main_window8\n");
  if(!qnode.setActuatorState(false))
  {printf("kudos_main_window9\n");
    writeLog("[ERR!!] Failed to send service");
    return;
  }
...
{printf("kudos_main_window14\n");
  std::vector<double> joint_angle;
  joint_angle.push_back(0.01);

  if(!qnode.setToolControl(joint_angle))
  {printf("kudos_main_window15\n");
    writeLog("[ERR!!] Failed to send service");
    return;
  }
...
{printf("kudos_main_window16\n");
  std::vector<double> joint_angle;
  joint_angle.push_back(-0.01);
  if(!qnode.setToolControl(joint_angle))
  {printf("kudos_main_window17\n");
    writeLog("[ERR!!] Failed to send service");
    return;
  }
...
{printf("kudos_main_window24\n");
  std::vector<double> joint_angle;
  joint_angle.push_back(ui.doubleSpinBox_gripper->value());
  if(!qnode.setToolControl(joint_angle))
  {printf("kudos_main_window25\n");
    writeLog("[ERR!!] Failed to send service");
    return;
  }
